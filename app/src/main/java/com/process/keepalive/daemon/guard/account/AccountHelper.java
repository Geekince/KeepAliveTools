...
public class AccountHelper {
    public static final String ACCOUNT_TYPE = "com.process.keepalive.daemon.guard.account.authenticator";
    public static final String ACCOUNT_PROVIDER = "com.process.keepalive.daemon.guard.account.sync_provider";
